...
def scan_blocks(chain, contract_info="contract_info.json"):
    ...
    if chain == 'source':
        ...
        for e in events:
            ...
            nonce = w3_other.eth.get_transaction_count(acct.address, 'pending')
            gas_price = int(w3_other.eth.gas_price * 1.1)  # 提高10% gas price
        ...
        for e in events:
            ...
            nonce = w3_other.eth.get_transaction_count(acct.address, 'pending')
            gas_price = int(w3_other.eth.gas_price * 1.1)
